...
/**
 * Adminhtml easytranslationplatform job edit form
 */
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('easytranslationplatform_job');

        /** @var \Magento\Framework\Data\Form $form */
        $form = $this->_formFactory->create(
            ['data' => ['id' => 'edit_form', 'action' => $this->getData('action'), 'method' => 'job']]
        );
