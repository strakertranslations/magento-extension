<?php
namespace Straker\EasyTranslationPlatform\Block\Adminhtml\Post;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Straker_EasyTranslationPlatform::save')) {
            $this->buttonList->update('save', 'label', __('Save EasyTranslationPlatform Post'));
            $this->buttonList->add(
                'saveandcontinue',
                [
        ...
        if ($this->_isAllowedAction('Straker_EasyTranslationPlatform::post_delete')) {
