Event.observe(window, "load", function() {
    ...
    var strakerMenu = $$('#nav LI.level0:has(SPAN:contains("Straker"))')[0];
    ...
    var strakerAccountLink = strakerMenu.select('A:has(span:contains("Account"))')[0];
    ...
    var strakerTermsLink = strakerMenu.select('A:has(span:contains("Terms"))')[0];
