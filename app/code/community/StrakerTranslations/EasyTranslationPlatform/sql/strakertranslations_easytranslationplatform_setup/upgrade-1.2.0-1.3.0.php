...
if ($connection->isTableExists($tableName) != true) {
    $table = $connection
        ...
        ->addColumn(
            ...
            $installer->getIdxName($rawTableName, 'block_id'),
            'block_id'
        )->addIndex(
            $installer->getIdxName($rawTableName, 'job_id'),
            'job_id'
        )->addForeignKey(
            $installer->getFkName($rawTableName, 'block_id', 'cms_block', 'block_id'),
...
if ($connection->isTableExists($tableName) != true) {
    $table = $connection
        ...
        ->addColumn(
            ...
            $installer->getIdxName($rawTableName, 'page_id'),
            'page_id'
        )->addIndex(
            $installer->getIdxName($rawTableName, 'job_id'),
            'job_id'
        )->addForeignKey(
            $installer->getFkName($rawTableName, 'page_id', 'cms_page', 'page_id'),
