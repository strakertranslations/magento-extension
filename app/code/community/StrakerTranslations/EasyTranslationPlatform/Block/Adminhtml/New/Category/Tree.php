...
//        return $this->getProduct()->getCategoryIds();
    ...
    {
        $sourceStoreId = $this->getRequest()->getParam('source_store_id', $this->_getDefaultStoreId());
...
//        if (is_null($root)) {
            $sourceStoreId = (int) $this->getRequest()->getParam('source_store_id', 0);

            if ($sourceStoreId) {
                $store = Mage::app()->getStore($sourceStoreId);
